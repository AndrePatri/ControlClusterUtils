...
class RtClusterDebugger(QMainWindow):
    ...
    def __init__(self, 
        ...
        rhc_pred_delta = RHCPredDelta(update_data_dt=self.data_update_dt, 
                    update_plot_dt=self.plot_update_dt,
                    window_duration=self.window_length, 
                    window_buffer_factor=self.window_buffer_factor, 
                    namespace=self.namespace,
        ...
        rhc_task_ref = RHCRefs(update_data_dt=self.data_update_dt, 
                            update_plot_dt=self.plot_update_dt,
                            window_duration=self.window_length, 
                            window_buffer_factor=self.window_buffer_factor, 
                            namespace=self.namespace,
        ...
        self.base_spawnable_tabs = [sim_info, 
                            cluster_info,
                            rhc_status, 
                            rhc_task_ref, rhc_cms, rhc_pred, rhc_pred_delta,
                            robot_state, 
                            rhc_internal_costs,
                            rhc_internal_constr,
                            rhc_internal_data]
